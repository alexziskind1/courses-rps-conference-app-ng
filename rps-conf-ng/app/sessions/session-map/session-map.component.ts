...
import { GestureEventData, SwipeGestureEventData, SwipeDirection, PanGestureEventData, PinchGestureEventData, TouchGestureEventData } from 'ui/gestures';
...
export class SessionMapComponent implements OnInit {
  ...
  private getNativeElement<T>(ref: ElementRef): T {
    return <T>ref.nativeElement;
  }

  private get imageWrapper(): View {
    return this.getNativeElement<View>(this.imageWrapperRef);
  }

  private get imgMap(): View {
    return this.getNativeElement<View>(this.imgMapRef);
  }

  private get imgPin(): View {
    return this.getNativeElement<View>(this.imgPinRef);
  }
